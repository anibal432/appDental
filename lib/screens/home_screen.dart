...
//import 'dental_analysis_screen.dart';
import '../ai_dental/screens/dental_analysis_screen.dart'; // Asegúrate de importar la pantalla de análisis
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: GridView.count(
          ...
          children: [
            _MenuCard(
              title: 'Análisis Dental',
              icon: Icons.health_and_safety,
              color: Colors.green,
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const DentalAnalysisScreen(),
                ),
              ),
            ),
            _MenuCard(
